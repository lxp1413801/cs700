...
extern int8_t __q7;
	...
	//#define bkup_FLOW_CALIBRATION_TABLE_ADDR (0x4000-0x100)
	#define main_SYSTEM_DATA_START_ADDR	(0x4000-0x100)
	#define bkup_SYSTEM_DATA_START_ADDR	(0x4000-0x180)
 	//#define bkup_FLOW_CALIBRATION_TABLE_ADDR (0x4000-0x200)
	//#define main_SYSTEM_DATA_START_ADDR	(0x4000-0x200)
	//#define bkup_SYSTEM_DATA_START_ADDR	(0x4000-0x300)   
    typedef struct
    {
        uint16_t adcValue;
	...
	extern const st_flowCalibrationTable Main_flowCalibrationTable;
...
extern const st_SystemData mainSystemData;
