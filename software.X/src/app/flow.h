...
extern "C" {
#endif
#define ADC_SAMPLING_BUFFER_SIZE 4
    ...
    extern volatile uint16_t rtVolume_m3  ; //(ms*L/min)/1000*60=ms*L/(1000*ms*60)=L
    extern volatile uint16_t rtVolume_L  ;
    ...
    extern void app_flow_rt_balance_money_cal(void);
    extern void app_flow_money_off(void);
    extern void flow_sampling_process(void);
    //extern void app_flow_all_calculation(void);

    //void app_flow_all_calculation(void)
    //extern uint16_t adcAverageValue;
