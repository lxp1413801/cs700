...
#define led4_on() IO_RA2_SetHigh();
#define led4_off() IO_RA2_SetLow();
#define led4_change() IO_RA2_Toggle();	
...
#define led5_on() IO_RA0_SetHigh();
#define led5_off() IO_RA0_SetLow();
#define led5_change() IO_RA0_Toggle();	
